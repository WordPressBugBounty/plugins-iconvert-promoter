	...
	<div class="body ">
		<div class="ic-upgrade-page">
			<div class="ic-upgrade-page-header">
				...
				<p class="description"><?php esc_html_e( 'Get access to 380+ premium templates, advanced targeting, email integrations, and powerful customization tools to boost conversions .', 'iconvert-promoter' ); ?></p>
			</div>
						...
						<div>
							...
							<h5><?php esc_html_e( 'How to Upgrade in 3 Simple Steps', 'iconvert-promoter' ); ?></h5>
								...
								$upgrade_steps = array(
									...
									array(
										'title' => esc_html__( 'Download the ExtendThemes PRO Installer', 'iconvert-promoter' ),
								...
								?>
							<ul class="ic-upgrade-steps-list">
								<?php foreach ( $upgrade_steps as $index => $step ) : ?>
									<li>
										<span class="ic-upgrade-step-number"><?php echo esc_html( $index + 1 ); ?></span>
										<span><strong><?php echo esc_html( $step['title'] ); ?></strong> - <?php echo esc_html( $step['desc'] ); ?></span>
									</li>
								<?php endforeach; ?>
							</ul>
						</div>
						<div class="ic-upgrade-steps-action">
							<a target="_blank" href="<?php echo esc_url( $upgrade_url ); ?>" class="ic-promo-button ic-promo-button-yellow">
								<?php esc_html_e( 'Upgrade to iConvert Promoter PRO', 'iconvert-promoter' ); ?>
							</a>
						</div>
					</div>
