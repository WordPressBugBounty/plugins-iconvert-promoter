...
<div class="promo-page-list-search-campaign">
	<form action="<?php echo esc_url( iconvertpr_generate_page_url( 'promos.list', array(), ICONVERTPR_PAGE_ID ) ); ?>">
		...
		<label>
			<input type="text" name="search-campaign" value="<?php echo esc_attr( isset( $_GET['search-campaign'] ) ? wp_unslash( $_GET['search-campaign'] ) : '' ); ?>" id="cs-search-campaign" placeholder="<?php esc_attr_e( 'Search campaign…', 'iconvert-promoter' ); ?>">
							...
							<div class="row align-items-stretch no-gutters">
								...
								<div class="col-4 wrapper-actions" data-col-group="actions">
									<div class="row no-gutters h-100 align-content-center">
										...
										<?php do_action( 'iconvertpr_popup_actions', $post['id'] ); ?>
									</div>
								</div>
							</div>
						</div>
