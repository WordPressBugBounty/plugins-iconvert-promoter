								...
								<select name="toggle-options-animation-in">
									<?php foreach ( Promos::get_available_effects() as $effect ) : ?>
										<?php if ( isset( $effect['value'] ) ) : ?>
											<option value="<?php echo esc_attr( $effect['type'] ); ?>#<?php echo esc_attr( $effect['value'] ); ?>"><?php echo esc_html( $effect['label'] ); ?></option>
										<?php else : ?>
																...
																<label class="input-group mb-0">
																	<select class="select2-dropdown js-active-field" name="which-pages-type">
																		...
																		<option value="products"
																			<?php echo ( ! function_exists( 'WC' ) ? 'disabled' : '' ); ?>
																				<?php
																				// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
																				...
																				if ( function_exists( 'WC' ) ) {
																					esc_html_e( 'All single products', 'iconvert-promoter' );
																				} else {
																					esc_html_e( 'All single products (requires WooCommerce)', 'iconvert-promoter' );
																				}
																				?>
																		</option>
