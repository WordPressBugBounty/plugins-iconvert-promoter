	...
	public function add_plugin_pages() {
		...
		if ( apply_filters( 'iconvertpr_feature_available_only_in_pro', true ) ) {
			...
			wp_add_inline_style(
				...
				'.iconvertpr-upgrade-menu-item .dashicons { color: #ffc932; font-size: 24px; vertical-align: middle; margin: -0.15em .15em 0 0; }' .
				'*:not(.current):not(:hover) > .iconvertpr-upgrade-menu-item .dashicons {opacity: 0.7; }'
			);
