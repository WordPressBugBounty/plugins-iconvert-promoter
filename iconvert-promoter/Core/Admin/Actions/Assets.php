...
class Assets {
	...
	public function __construct() {
		...
		if ( isset( $_GET['page'] ) && in_array( $_GET['page'], $allowed_pages, true ) ) {
            ...
            add_action('admin_enqueue_scripts', array($this, 'remove_woo_select2_conflict'), 9999);
    ...
    public function remove_woo_select2_conflict() {
	...
	public function load() {
		//select2
		wp_enqueue_script( 'iconvertpr-select2', $this->assets_url( 'js/select2/js/select2.min.js' ), array(), '4.1.0', true );
		wp_enqueue_style( 'iconvertpr-select2', $this->assets_url( 'js/select2/css/select2.min.css' ), array(), '4.1.0' );
		...
		wp_enqueue_script( 'iconvertpr-popups', $this->assets_url( 'js/dist/index.js' ), array( 'jquery', 'iconvertpr-select2', 'cs-snackbar' ), ICONVERTPR_VERSION, true );
